...
Çalıştırma:
    python rota_backtest.py THY322 2019-01-15
    python rota_backtest.py --hepsi
"""
...
from models import RotaBacktesti, Ucus
from risk_katmanlari import SigmetKisitKatmani, rota_ti1_degerleri
from rota_optimizasyonu import buyuk_daire_mesafesi_km, rota_simulasyonu_olustur
from sigmet_saglayici import gecerli_sigmetleri_getir
from veri_saglayicilari import veri_kupu_kaynagi, veri_kupunu_sec
from veritabani import motor_al, ucus_olcumlerini_dataframe_olarak_getir
