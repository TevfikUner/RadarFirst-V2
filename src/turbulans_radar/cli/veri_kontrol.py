...
Kullanım:
    python -m turbulans_radar.cli.veri_kontrol N10VZ 2019-01-15
"""
...
from turbulans_radar.depo.veritabani import VeritabaniAyarlariEksikHatasi, ucus_olcumlerini_dataframe_olarak_getir
