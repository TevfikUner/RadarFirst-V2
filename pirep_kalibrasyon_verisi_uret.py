...
Çalıştırma:
    python pirep_kalibrasyon_verisi_uret.py
    python kalibrasyon.py pirep_kalibrasyon_verisi.csv
"""
...
from turbulans_ml_modeli import ozellikleri_cikar, ozellikleri_temizle
